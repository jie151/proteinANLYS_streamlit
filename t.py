...
# return data_colname, df_ncol_py, median_list_py
...
@st.cache_data
def cache_DEP_data1(filename_py, session_id, species_py_new, colname_geneNames_py, colname_proteinIDs_py, filer_missing_values, normalizeOption_py):
    os.system(f"Rscript dep1_to_1_5.r {filename_py} {session_id} {species_py_new} {colname_geneNames_py} {colname_proteinIDs_py} {normalizeOption_py} {filer_missing_values['option']} {filer_missing_values['nThr']} {filer_missing_values['min']}")
    # plot1_1
    try:
...
@st.cache_data
def cache_DEP_data2(filename_py, session_id, species_py_new, colname_geneNames_py, colname_proteinIDs_py, filer_missing_values, normalizeOption_py, control_py, alpha_py, lfc_py, contrast_py):
    os.system(f"Rscript dep2_1_6_to_1_8_1_10.r {filename_py} {session_id} {species_py_new} {colname_geneNames_py} {colname_proteinIDs_py} {normalizeOption_py} {filer_missing_values['option']} {filer_missing_values['nThr']} {filer_missing_values['min']} {control_py} {contrast_py} {alpha_py} {lfc_py} ")
    # plot1_6
...
@st.cache_data
def cache_DEP_data3(filename_py, session_id, species_py_new, colname_geneNames_py, colname_proteinIDs_py, filer_missing_values, normalizeOption_py, control_py, alpha_py, lfc_py, num_protein, proteinData_py):
        ...
        try:
            with open(f"./file/{session_id}/proteinData.txt", "w") as f:
                for protein in proteinData_py:
                    f.write(protein)
                    f.write("\n")
            os.system(f"Rscript dep3_1_9.r {filename_py} {session_id} {species_py_new} {colname_geneNames_py} {colname_proteinIDs_py} {normalizeOption_py} {filer_missing_values['option']} {filer_missing_values['nThr']} {filer_missing_values['min']} {control_py} {alpha_py} {lfc_py} {protein_type}")
...
def config_data():
    ...
    if st.session_state.CONFIG:
        ...
        # plot 1_1~1_5
        cache_DEP_data1(filename_py, session_id, species_py_new, colname_geneNames_py, colname_proteinIDs_py, filer_missing_values, normalizeOption_py)

        st.header("5. Differential enrichment analysis")
        # 1_6~1_8, 1_10
        cache_DEP_data2(filename_py, session_id, species_py_new, colname_geneNames_py, colname_proteinIDs_py, filer_missing_values, normalizeOption_py, control_py, alpha_py, lfc_py, contrast_py)
        ...
        cache_DEP_data3(filename_py, session_id, species_py_new, colname_geneNames_py, colname_proteinIDs_py, filer_missing_values, normalizeOption_py, control_py, alpha_py, lfc_py, num_protein, proteinData_py)
